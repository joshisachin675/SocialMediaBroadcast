...
namespace RepositoryLayer.Repositories
{
    public class ActionAccessPermissionRepository : BaseRepository<ActionAccessPermission>, IActionAccessPermissionRepository
    {
        ...
        {
            var objLoginAuthentication = Context.Set<smLoginAuthentication>()
        ...
        {
            var loginAuthentication = Context.Set<smLoginAuthentication>().FirstOrDefault(u => u.TokenId == Guid.Parse(tokenId));
