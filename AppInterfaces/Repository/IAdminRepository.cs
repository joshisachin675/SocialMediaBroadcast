...
namespace AppInterfaces.Repository
{
    ...
    {
        List<Users> GetUserList(int limit, int offset, string order, string sort, string FirstName, string LastName, string EmailId, string Photo, out int total);
        List<Users> GetEndUserList(int limit, int offset, string order, string sort, string FirstName, string LastName, string EmailId, string Photo, int userType, int Role, int industryId, out int total);
