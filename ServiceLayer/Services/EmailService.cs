...
namespace ServiceLayer.Services
{
    ...
    public class EmailService : IEmailService
    {
        ...
        public void SendRegistrationEmail(string fullname, string email, string toAddress)
        {
            ...
            _messageSender.SendAsync(_config.FromAddress, toAddress, "Welcome to " + @System.Configuration.ConfigurationManager.AppSettings["ApplicationName"] + "", mailMessage, _config.CC_RegistrationEmail, _config.BCC_RegistrationEmail);
        }
