...
namespace ServiceLayer.Interfaces
{
    public interface IPostService
    {
        ...
        smPost SaveLinkedInPost(smSocialMediaProfile data, string image, int userId, string title, string url, string message, string post, int? postType, DateTime? scheduledDate, int ImpersonateUserId, string heading, string PostMethod);
