...
namespace smartData.App_Start
{
    ...
    using smartData.Areas.Users.Controllers;
    ...
    public static class NinjectWebCommon
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IHomeAPIController>().To<HomeAPIController>();
            kernel.Bind<IPostAPIController>().To<PostAPIController>();
            kernel.Bind<IManageAdminAPIController>().To<ManageAdminAPIController>();
            kernel.Bind<IManageUserAPIController>().To<ManageUserAPIController>();
            kernel.Bind<IManageContentAPIController>().To<ManageContentAPIController>();
            kernel.Bind<IManageCategoryAPIController>().To<ManageCategoryAPIController>();
            kernel.Bind<IManageRssFeedAPIController>().To<ManageRssFeedsAPIController>();
            kernel.Bind<IScheduleAPIController>().To<ScheduleAPIController>();
            kernel.Bind<IPreferenceAPIController>().To<PreferenceAPIController>();
           ...
           // kernel.Bind<IModuleAPIController>().To<ModuleAPIController>();
            ...
            kernel.Bind<IHomeService>().To<ServiceLayer.Services.HomeService>();
            kernel.Bind<IPostService>().To<ServiceLayer.Services.PostService>();
            kernel.Bind<IAdminService>().To<ServiceLayer.Services.AdminService>();
            kernel.Bind<IManageAdminService>().To<ServiceLayer.Services.ManageAdminService>();
            kernel.Bind<IManageUserService>().To<ServiceLayer.Services.ManageUserService>();
            kernel.Bind<IManageContentService>().To<ServiceLayer.Services.ManageContentService>();
            kernel.Bind<IManageCategoryService>().To<ServiceLayer.Services.ManageCategoryService>();
            kernel.Bind<IManageRssFeedService>().To<ServiceLayer.Services.ManageRssFeedService>();
            kernel.Bind<IScheduleService>().To<ServiceLayer.Services.ScheduleService>();
            kernel.Bind<IPreferenceService>().To<ServiceLayer.Services.PreferenceService>();
            kernel.Bind<IHomeValueService>().To<ServiceLayer.Services.HomeValueService>();
        }
    }
}
