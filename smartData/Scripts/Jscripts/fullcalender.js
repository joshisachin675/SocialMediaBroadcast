    ...
    $e.mixin({
        ...
        fgSegHtml: function (t, e) {
            ...
            var n, i = this.view,
                ...
                u = "";
            if (r.title.indexOf("Please select the time for which you want to pos") > -1) {
                return true;
            }
            return l.unshift("fc-day-grid-event"), !r.allDay && t.isStart &&
                (
               ss= "<div class='fa fa-trash' style='color:black;' title='Delete Event' onclick='DeleteEvent(" + r.id + ")'></div>",
                n =ss+ '<span class="fc-title">' + (z(r.title || "") || "&nbsp;"),
                 u = ' <span class="fc-time fa fa-edit" style="color:black"  onclick="EditTime(this)" title="Edit Time"  > ' +( z(this.getEventTimeText(r).indexOf("p")) < 0 ? z(this.getEventTimeText(r)).replace("a", "am") : z(this.getEventTimeText(r)).replace("p", "pm") )+ "</span> "  +
                " </br>"),
                +"</span>", '<a class="' + l.join(" ") + '"' + (r.url ? ' href="' + z(r.url) + '"' : "") + (a ? ' style="' + a + '"' : "") + ">" + '<div class="fc-content">' + (this.isRTL ? n + " " + u : u + " " + n) + "</div>" + (o ? '<div class="fc-resizer"/>' : "") + "</a>"
        },
    ...
    Ue.mixin({
        ...
        fgSegHtml: function(t, e) {
            ...
            return u.unshift("fc-time-grid-event"), s.isMultiDayEvent(o) ? (t.isStart || t.isEnd) && (n = this.getEventTimeText(t), i = this.getEventTimeText(t, "LT"), r = this.getEventTimeText({
                ...
                start: o.start
            })), '<a class="' + u.join(" ") + '"' + (o.url ? ' href="' + z(o.url) + '"' : "") + (d ? ' style="' + d + '"' : "") + ">" + '<div class="fc-content">' + (n ? '<div class="fc-time" data-start="' + z(r) + '"' + ' data-full="' + z(i) + '"' + ">" + "<span>" + z(n) + "</span>" + "</div>" : "") + (o.title ? '<div class="fc-title">' + z(o.title) + "<div class='fa fa-times' style='float:right' title='Delete Event' onclick='DeleteEvent(" + o.id + ")'></div> </div>" : "") + "</div>" + '<div class="fc-bg"/>' + (a ? '<div class="fc-resizer"/>' : "") + "</a>"
        },
